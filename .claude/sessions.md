...
| invariants-2-3-4 | Invariant #2 Stock Atomique (useStockDeduction.ts → Nexus.adapter.increment + test), vérification #3 CAS (déjà livré), vérification #4 UTC (déjà livré) | 2026-08-15 | active |
