...
| ui-refactor-phases1-6 | Exécution plan AUDIT_UI.md Ph1→Ph6 : doublons (25 fichiers), orphelins, barrel ui/index.ts, tokens CSS hex→variables, couche atomique, floor-plan responsive — src/shared/components/, src/modules/, globals.css | 2026-08-07 | active |
