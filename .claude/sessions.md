...
| vertical-forge | Skill Vertical Forge — analyse infra verticales (src/verticals/, IVerticalPlugin, VerticalRegistry, seeds DNA, SystemTenantRegistry, LegalContractGenerator, HardwareProvisioningService, vertical.events) puis développement verticale(s) manquante(s) | 2026-08-15 | active |
