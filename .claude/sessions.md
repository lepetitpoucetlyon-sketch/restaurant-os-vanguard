...
| docs-rangement | **Rangement documentation** : racine (42 `.md` → 6 canoniques) + réorg `docs/` en sous-dossiers (plans/specs/handoffs/audits/guides/reference/architecture). Fusion des 4 doublons divergents (ARCHITECTURE, CHANGELOG, PLAN_RESTE_A_FAIRE, A_FAIRE/afaire), `git mv` (préserve historique), reliage des liens + `docs/README.md` index, MAJ des plans d'après les commits. Touche UNIQUEMENT des `.md` + arbo `docs/`. | 2026-08-12 | active |
