...
| audit-complet-v3 | Audit global structure projet tous angles : TSC, tests, arborescence, barrels, cycles, orphelins, CLAUDE.md drift — Auto-clôturée 2026-08-18, aucun livrable identifié | 2026-08-07 | terminée |
| typing-unknown-eradication | Éradication des 913 `unknown` — typage strict par catégorie (catch/Record/casts/generics/adapters). Périmètre large src/ + nouveaux types partagés (JsonValue, toError) — Auto-clôturée 2026-08-18, périmètre repris par `plan-correction-semaine` | 2026-08-07 | terminée |
...
| plan-correction-semaine | Rédaction PLAN_CORRECTION_2026-08-18.md — plan ultra-détaillé 4 vagues (hygiène/finition/critiques/gouvernance) basé sur AUDIT_2026-08-18_full.md + livraisons 15-17 août | 2026-08-18 | active |
| rbac-desambiguation-final | Finition rbac-rename : super_admin MCC → mcc_super_admin (65+ occurrences dans 43 fichiers), TENANT_ADMIN_ROLES purgé de super_admin (faille cross-scope fermée), fix bug trusted-devices triplé, normalizeMccRole() avec alias legacy pour tokens Firebase existants. Résultat : TSC 0, 1161/1161 tests, sentrux quality 3346→5367, 0 cycle, gate GREEN. | 2026-08-18 | terminée |
| barrel-godfiles-purge | Baisser barrel-debt ESLint (193→<103, retour au niveau post-cycles) + décomposer god files (18→cible ≤10). Périmètre : imports profonds cross-pilier (Barrel Contract) + fragmentation des 6 vrais god files hors registerHandlers/tests. Résultat : god files 18→13, barrel 193→150, TSC 0, cycles 0. | 2026-08-19 | terminée |
| attack-consolidation-master | Attaque intensive PLAN_CONSOLIDATION Vague α + démarrages γ-3/γ-7/β-2. Périmètre : barrel debt finition, kernel/ création, RBAC table unique, DLQ dashboard, bundle monitoring. | 2026-08-19 | active |
