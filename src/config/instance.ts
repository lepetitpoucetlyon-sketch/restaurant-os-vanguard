import type { BusinessIdentity } from '@nexus/contracts';
...
export interface WhiteLabelInstanceConfig {
    ...
    ai: AIInstanceConfig;
    identityDefaults: BusinessIdentity;
}
...
export const whiteLabelInstanceConfig: WhiteLabelInstanceConfig = {
    ...
    identityDefaults: {
        ...
        activityCategory: process.env.NEXT_PUBLIC_RESTAURANT_CUISINE || 'Française',
        category: (process.env.NEXT_PUBLIC_RESTAURANT_CATEGORY as string) || 'bistrot',
        ...
        keyContact2: process.env.NEXT_PUBLIC_KEY_CONTACT_2 || process.env.NEXT_PUBLIC_RESTAURANT_OWNER || '',
