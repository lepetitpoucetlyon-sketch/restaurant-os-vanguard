...
} from '@/verticals/restaurant/commerce/acquisition/marketing/store/crmAtoms';
import { crmsAtom, selectedCRMAtom } from '@/verticals/restaurant/commerce/acquisition/marketing/store/marketingAtoms';
