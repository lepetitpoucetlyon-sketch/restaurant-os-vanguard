...
interface QuoteCRMFormProps {
    crmType: 'individual' | 'company';
    setCRMType: (val: 'individual' | 'company') => void;
    crmName: string;
    setCRMName: (val: string) => void;
    crmEmail: string;
    setCRMEmail: (val: string) => void;
    subject: string;
    setSubject: (val: string) => void;
}

export function QuoteCRMForm({
    crmType, setCRMType,
    crmName, setCRMName,
    crmEmail, setCRMEmail,
    subject, setSubject
}: QuoteCRMFormProps) {
    return (
