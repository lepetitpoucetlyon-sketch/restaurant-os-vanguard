...
import { usePlanning } from "@/verticals/restaurant/human/staffing/hr";
import type { Shift as ContextShift } from "@/verticals/restaurant/human/staffing/hr/types";
...
export function PlanningDashboard() {
    ...
    const { users } = useAuth();
    const { shifts, addShift, updateShift, deleteShift, publishShifts, isLoading: _isLoading } = usePlanning();
