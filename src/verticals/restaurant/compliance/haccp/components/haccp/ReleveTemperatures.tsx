...
import { EQUIPMENT_CONFIG, EquipmentConfig } from '@verticals/restaurant/compliance/haccp/types';
import { useHygieneLogs, useCreateHygieneLog } from '@nexus/guards/NexusGuardProvider';
import { useNotifications } from '@/shared/contexts/NotificationsContext';
import { useTenant } from '@/shared/hooks';
import { HACCPLogService } from '@verticals/restaurant/compliance/haccp/HACCPLogService';
