...
import {
  VeterinaryOpsAdapter,
  VeterinaryCommerceAdapter,
  VeterinaryFinanceAdapter,
  VeterinaryFacilityAdapter,
  VeterinaryHumanAdapter,
  VeterinaryIntelligenceAdapter,
  VeterinaryLogisticsAdapter,
  VeterinaryComplianceAdapter,
