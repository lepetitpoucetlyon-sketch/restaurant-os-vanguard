...
export const operationsTranslations = {
    ...
    en: {
        ...
        crm: {
            database_title: "Database", concierge_title: "Concierge", clients_subtitle: "Clients", search_placeholder: "SEARCH A PROFILE...", global_portfolio: "Global Portfolio", lifetime_value: "Total Lifetime Value", all_clients: "All Clients", export_db: "EXPORT DATABASE", new_profile: "NEW PROFILE", visits: "Visits", value: "Value", last_visit: "Last", contact_info: "Contact Information", personalized_exp: "Personalized Experience", operational_comments: "Operational Comments", ledger_title: "Reservation Ledger", new_table: "New Table", new_profile_title: "New Guest Profile", secure_db: "Registration in secured database", full_name: "Full Name", phone: "Phone", email: "Email Address", birthday: "Birthday", segment: "Segment", operational_note: "Operational Note", abandon: "Abandon", save_profile: "Save Profile",
