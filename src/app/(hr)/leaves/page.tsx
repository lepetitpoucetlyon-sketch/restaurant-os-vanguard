...
import { NewRequestModal } from '@/components/leaves/NewRequestModal';
import { TeamCalendar } from '@/components/leaves/TeamCalendar';
import { useAtomValue } from 'jotai';

import { useAuth } from '@/context/AuthContext';
import { useHR } from '@/engines/ops/NexusOpsProvider';
...
export default function LeavesPage() {
    ...
    const isManager = currentUser?.role === 'manager' || currentUser?.role === 'admin' || (currentUser?.role as any) === 'owner';
    ...
    const myBalances = balances.filter(b => b.employeeId === currentUser?.id);
