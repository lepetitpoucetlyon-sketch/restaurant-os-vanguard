...
import type { EInvoiceWebhookPayload } from '@/modules/finance';
import { parseEInvoiceXml } from '@/modules/finance';
...
export async function POST(req: Request): Promise<NextResponse> {
  try {
    ...
    const { tenantEInvoiceConfigPath, PLATFORM_EINVOICE_CONFIG_PATH } = await import('@/modules/finance');
