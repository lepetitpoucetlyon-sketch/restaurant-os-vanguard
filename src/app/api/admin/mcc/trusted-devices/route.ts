...
/**
 * GET /api/admin/mcc/trusted-devices
...
/**
 * POST /api/admin/mcc/trusted-devices
...
/**
 * PATCH /api/admin/mcc/trusted-devices
...
/**
 * DELETE /api/admin/mcc/trusted-devices?deviceId=xxx
