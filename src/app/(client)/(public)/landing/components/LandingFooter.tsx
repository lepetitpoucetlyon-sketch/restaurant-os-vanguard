                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="md:col-span-1">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <span className="text-white font-brand text-xl font-semibold">Restaurant OS</span>
                        </div>
                        <p className="text-white/40 text-sm leading-relaxed mb-6">
                            L'intelligence exécutive pour restaurateurs visionnaires.
                        </p>
                        <div className="flex gap-4">
                            <a href="#" className="w-10 h-10 rounded-xl bg-surface-card flex items-center justify-center text-white/40 hover:text-white hover:bg-surface-card transition-all">
