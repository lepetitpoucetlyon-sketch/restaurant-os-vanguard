                ...
                >
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <div>
                            ...
                            <p className="text-zinc-500 text-xs mt-1 font-sans">PROTOCOL_EXCALIBUR_RECOVERY_MODE</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            <button 
                                ...
                                className="w-full h-14 bg-red-600 hover:bg-red-500 text-white font-bold uppercase tracking-widest transition-all active:scale-95 flex items-center justify-center gap-3 rounded-lg"
                            >
                    ...
                    <div className="mt-12 flex justify-between items-end">
                        <div className="space-y-1">
                            <p className="text-[10px] text-zinc-700 uppercase">System_Status</p>
                            <div className="flex gap-1">
                                {[1, 2, 3, 4, 5].map(i => (
                                    <div key={i} className="w-3 h-1 bg-red-900/30 overflow-hidden">
                                        <motion.div 
                                            animate={{ x: ['-100%', '100%'] }}
                        ...
                        <div className="text-right">
                            <p className="text-[10px] text-zinc-700 italic">EXCALIBUR_9_BIOLOGIQUE_ACTIVE</p>
                            <p className="text-[10px] text-zinc-800">grade_vi_lockdown_v5.4</p>
                        </div>
                    </div>
                </motion.div>

                <p className="text-center mt-8 text-red-900/40 text-[10px] uppercase tracking-[0.5em] font-bold">
