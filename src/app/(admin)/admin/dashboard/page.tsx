        ...
        >
          <div>
            <h1 className="text-4xl font-light tracking-tight text-white/90">
              Restaurant <span className="font-semibold text-white">Vanguard</span>
            </h1>
          ...
          <div className="text-right">
            <p className="text-sm font-medium text-neutral-500 uppercase tracking-wider">Session Active</p>
            <p className="text-lg text-white/80">{new Date().toLocaleDateString('fr-FR', { day: 'numeric', month: 'long', year: 'numeric' })}</p>
          </div>
        </motion.div>
              ...
              {recentOrdersList.length > 0 ? recentOrdersList.map((order, i) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-medium text-white/90">{order.table}</p>
                  ...
                  <div className="text-right">
                    <p className="font-medium text-white/90">{order.amount}</p>
            ...
            <div className="flex-1 space-y-6">
              <div className="p-4 rounded-2xl bg-emerald-500/10 border border-emerald-500/20">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h3 className="font-medium text-emerald-400">Scellement NF525</h3>
                </div>
                <p className="text-sm text-emerald-400/80">Tous les tickets sont correctement scellés. Chaîne cryptographique intacte.</p>
              </div>

              <div className="space-y-3">
                <h3 className="text-sm font-medium text-neutral-400 uppercase tracking-wider mb-4">Actions Rapides</h3>
