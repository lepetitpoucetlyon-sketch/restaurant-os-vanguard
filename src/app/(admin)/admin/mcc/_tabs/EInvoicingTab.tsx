        ...
        <div className="space-y-8">
            ...
            <div className="bg-surface-card border border-border-subtle rounded-2xl p-6 space-y-4">
                ...
                <div className="bg-status-warning/5 border border-status-warning/20 rounded-xl p-4 text-sm">
                    <p className="font-bold text-status-warning mb-1">Partenaire de Dématérialisation non sélectionné</p>
            ...
            <div className="flex items-center gap-2 text-xs text-secondary">
                ...
                <span>Module <code>finance/fiscalite/e-invoicing</code> livré — en attente de configuration PDP par décision humaine §D1</span>
            </div>
        </div>
    );
}
