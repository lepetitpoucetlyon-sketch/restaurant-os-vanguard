        ...
        <div className="space-y-8 pb-12">
            ...
            <div className="relative h-[300px] bg-surface-card border border-border-subtle rounded-3xl overflow-hidden group">
                ...
                <div className="absolute top-6 left-8 z-10">
                    <h3 className="text-xs font-black text-text-primary/40 uppercase tracking-[0.3em] mb-1">{"Cartographie du Parc"}</h3>
                    <p className="text-nano text-secondary font-medium tracking-tight">{"Distribution des établissements en temps réel ("}{instances.length}{" unités)"}</p>
                </div>
                ...
                <div className="col-span-12 lg:col-span-7 space-y-4">
                    <div className="flex justify-between items-center mb-6">
                        <div className="flex items-center gap-3">
                            ...
                            <h3 className="text-sm font-black uppercase tracking-widest">{"Analyses & Recommandations"}</h3>
                        </div>
                    ...
                    <div className="bg-surface-card border border-border-subtle rounded-3xl p-8 flex flex-col h-[500px]">
                        <div className="flex items-center justify-between mb-8">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-nano font-black text-secondary uppercase tracking-widest">{"Synthèse de Gestion"}</span>
                            </div>
                            <motion.button
                            ...
                            >
                                ...
                                {isProcessing ? 'Analyse...' : 'Actualiser'}
                            </motion.button>
                        </div>
