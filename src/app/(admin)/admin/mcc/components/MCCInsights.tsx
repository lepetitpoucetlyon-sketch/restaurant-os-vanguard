...
import { FleetInsight, MacroBrain } from '@/shared/nexus/engines/Intelligence/services/MacroBrain';
                ...
                >
                    ...
                    <div className="flex items-start justify-between gap-4 mb-4">
                        <div className="flex items-center gap-3">
                            <div className={`p-2 rounded-xl ${insight.type === 'anomaly' ? 'bg-status-warning/10' : 'bg-status-success/10'}`}>
