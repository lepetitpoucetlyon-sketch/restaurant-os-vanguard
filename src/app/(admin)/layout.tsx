...
export default function AdminLayout({ children }: { children: ReactNode }) {
    ...
    if (isAuthLoading || !currentUser) {
        return (
            <div className="min-min-h-[100dvh] flex items-center justify-center bg-surface-bg">
    ...
    if (!ADMIN_ROLES.includes(role)) {
        return (
            <div className="min-min-h-[100dvh] flex flex-col items-center justify-center gap-4 bg-surface-bg text-text-primary">
