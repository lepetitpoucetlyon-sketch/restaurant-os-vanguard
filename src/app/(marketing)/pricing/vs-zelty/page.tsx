...
export const metadata: Metadata = {
  ...
  description: 'Comparez Restaurant OS et Zelty : fonctionnalités, tarifs, conformité NF525, mode hors ligne. Découvrez pourquoi Restaurant OS est l\'alternative intelligente.',
};

export default function VsZeltyPage() {
  const features = [
    ...
    { feature: 'API ouverte', ros: true, competitor: false },
    { feature: 'Plan de salle interactif', ros: true, competitor: true },
    { feature: 'Stock & recettes', ros: true, competitor: true },
    { feature: 'MCC multi-établissements', ros: true, competitor: true },
    { feature: 'Sauvegarde automatique quotidienne', ros: true, competitor: false },
    ...
    <section className="pt-32 pb-24 sm:pt-40 sm:pb-32">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl sm:text-4xl font-bold tracking-tight mb-4 text-center">
          Restaurant OS vs <span className="text-amber-400">Zelty</span>
        </h1>
          ...
          <table className="w-full text-sm min-w-[37.5rem]">
            <thead>
              <tr className="bg-white/[0.03]">
                ...
                <th className="text-center px-6 py-4 font-medium text-white/60">Zelty</th>
              </tr>
            </thead>
            <tbody>
              {features.map((row, i) => (
