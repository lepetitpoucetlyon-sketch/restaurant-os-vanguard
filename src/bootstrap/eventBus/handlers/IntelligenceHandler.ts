...
import { HermesKnowledgeManager } from '@/src/modules/intelligence/knowledge/rag/HermesKnowledgeManager';;
...
async function analyzeStockTrend(tenantId: string, items: import("@/shared/nexus/contracts/ops.engine.types").CartItem[]): Promise<void> {
  try {
