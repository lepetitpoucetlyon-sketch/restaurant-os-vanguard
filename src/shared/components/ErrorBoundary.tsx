...
export class ErrorBoundary extends Component<Props, State> {
    ...
    public render() {
        if (this.state.hasError) {
            return (
                <div className="min-h-[100dvh] flex items-center justify-center bg-bg-primary p-8">
                    <div className="max-w-md w-full card-premium p-10 text-center space-y-6">
                        ...
                        <Button
                            ...
                            className="w-full bg-action-primary hover:bg-action-primary-hover text-text-on-primary h-12 rounded-xl font-black text-micro uppercase tracking-[0.2em]"
                        >
