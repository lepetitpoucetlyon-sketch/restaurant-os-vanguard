            ...
            {isLocked && (
                ...
                >
                    <div className="max-w-md w-full bg-surface-card border border-status-danger/20 rounded-3xl p-10 text-center shadow-[0_0_100px_rgba(239,68,68,0.1)] relative overflow-hidden">
                        ...
                        <button 
                            className="w-full h-14 bg-status-danger hover:bg-status-danger/90 text-text-on-primary rounded-2xl font-bold uppercase tracking-widest text-xs transition-colors flex items-center justify-center gap-3 shadow-[0_10px_30px_rgba(239,68,68,0.2)]"
                        >
