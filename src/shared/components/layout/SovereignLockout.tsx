    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/80 backdrop-blur-xl animate-in fade-in duration-500">
      <div className="w-full max-w-lg p-8 mx-4 border border-border rounded-3xl bg-surface-card shadow-2xl text-center space-y-8">
        ...
        <div className="pt-6 border-t border-border">
          <button className="flex items-center justify-center gap-2 w-full p-4 rounded-2xl bg-surface-glass hover:bg-surface-card text-text-primary font-medium transition-all group">
