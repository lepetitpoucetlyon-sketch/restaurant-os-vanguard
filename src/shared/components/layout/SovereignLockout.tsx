...
export function SovereignLockout() {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-surface-sidebar/80 backdrop-blur-xl animate-in fade-in duration-500">
      <div className="w-full max-w-lg p-8 mx-4 border border-subtle rounded-3xl bg-surface-bg/50 shadow-2xl text-center space-y-8">
        ...
        <div className="space-y-3">
          <h1 className="text-3xl font-serif font-bold text-text-primary tracking-tight">
        ...
        <div className="pt-6 border-t border-white/5">
          <button className="flex items-center justify-center gap-2 w-full p-4 rounded-2xl bg-surface-card/5 hover:bg-surface-card/10 text-text-primary font-medium transition-all group">
