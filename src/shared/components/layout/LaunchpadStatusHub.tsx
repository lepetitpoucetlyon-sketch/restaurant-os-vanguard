            ...
            >
                <div className="bg-surface-card/40 dark:bg-surface-card/5 backdrop-blur-[40px] rounded-full border border-default dark:border-white/5 shadow-2xl p-2 md:p-3 flex items-center gap-3 md:gap-6 scale-90 md:scale-100 origin-center ring-1 ring-black/5 dark:ring-white/5">
                        ...
                        <AnimatePresence>
                            {isLangMenuOpen && (
                                <motion.div
                                    ...
                                    className="absolute top-full mt-4 left-1/2 -translate-x-1/2 min-w-[10rem] bg-surface-card backdrop-blur-xl rounded-2xl shadow-premium border border-border-default overflow-hidden z-[60]"
                                >
                                    {LANGUAGES.map((lang) => (
                                        <button
                                            key={lang.code}
                    ...
                    >
                        ...
                        {unreadCount > 0 && (
                            <div className="absolute top-2 right-1.5 px-1.5 py-0.5 min-w-[22px] bg-status-danger text-text-primary flex items-center justify-center text-nano font-bold rounded-full border-2 border-white dark:border-black shadow-sm z-20">
