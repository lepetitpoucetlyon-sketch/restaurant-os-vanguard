        ...
        <div className="mb-6">
            ...
            <div className="flex flex-wrap gap-2">
                {roleUsers.map((user: User) => (
                    ...
                    >
                        <div className="w-6 h-6 rounded-full bg-text-primary dark:bg-action-primary text-text-primary dark:text-bg-primary text-nano font-bold flex items-center justify-center">
                            {(user.name || '').charAt(0)}
                        </div>
                        ...
                        <select
                            ...
                            className="ml-1 text-micro bg-transparent border border-action-primary/20 rounded-lg px-2 py-1 text-text-muted cursor-pointer hover:border-action-primary/60 disabled:opacity-50 transition-colors"
