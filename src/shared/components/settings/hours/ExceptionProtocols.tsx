        ...
        >
            ...
            <div className="flex items-center justify-between mb-10">
                <div className="flex items-center gap-4 relative z-10">
                    ...
                    <div>
                        ...
                        <p className="text-nano font-black text-text-muted uppercase tracking-[0.4em] ml-1">Calibration des Fenêtres de Service Exceptionnelles</p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-[1fr_1fr_1fr_auto] gap-4 p-4 bg-bg-primary rounded-[2rem] border border-border shadow-inner mb-8">
                <div className="space-y-2">
                    <label className="text-nano font-bold text-text-muted uppercase tracking-widest px-2">Date de Début</label>
                    <input
                        type="date"
                ...
                <div className="space-y-2">
                    <label className="text-nano font-bold text-text-muted uppercase tracking-widest px-2">Date de Fin</label>
                    <input
                        type="date"
                ...
                <div className="space-y-2">
                    <label className="text-nano font-bold text-text-muted uppercase tracking-widest px-2">Motif de Fermeture</label>
                    <input
                        type="text"
            ...
            <div className="space-y-4">
                            ...
                            <div className="flex items-center gap-8">
                                <div className="flex items-center gap-4">
                                    <div className="text-center">
                                        ...
                                        <div className="text-nano font-bold text-status-danger uppercase">{new Date(period.startDate).toLocaleDateString('fr-FR', { month: 'short' })}</div>
                                    </div>
                                    ...
                                    <div className="text-center">
                                        ...
                                        <div className="text-nano font-bold text-status-danger uppercase">{new Date(period.endDate).toLocaleDateString('fr-FR', { month: 'short' })}</div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="text-nano font-bold text-status-danger uppercase tracking-widest">
                ...
                {closedPeriods.length === 0 && (
                    <div className="text-center py-12 border-2 border-dashed border-border/50 rounded-[2.5rem]">
                        <p className="text-nano font-black text-text-muted uppercase tracking-[0.3em]">Aucun Protocole d'Exception Détecté</p>
                    </div>
                )}
            </div>
        </motion.div>
