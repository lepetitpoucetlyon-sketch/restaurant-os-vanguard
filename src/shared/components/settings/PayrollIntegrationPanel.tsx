            ...
            <div className="flex items-center gap-3">
                ...
                <div className="relative">
                    <input
                        ...
                        className="pl-3 pr-8 py-1.5 text-sm border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                ...
                {activeTab === 'silae' && (
                    <div className="space-y-5">
                        ...
                        <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-4 space-y-3">
                            <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300">Connexion Silae</h4>
                            <div className="grid grid-cols-2 gap-3">
                                <div>
                                    <label className="text-xs text-gray-500 dark:text-gray-400 mb-1 block">Clé API</label>
                                    <input
                                        type="password"
                                        placeholder="sk-silae-..."
                                        value={connectForm.silaeApiKey}
                                        onChange={e => setConnectForm(f => ({ ...f, silaeApiKey: e.target.value }))}
                                        className="w-full px-3 py-1.5 text-sm border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                    />
                                </div>
                                <div>
                                    <label className="text-xs text-gray-500 dark:text-gray-400 mb-1 block">N° Dossier</label>
                                    <input
                                        type="text"
                                        placeholder="12345"
                                ...
                                <div className="col-span-2">
                                    <label className="text-xs text-gray-500 dark:text-gray-400 mb-1 block">URL base (optionnel)</label>
                                    <input
                                        type="text"
                            ...
                            <button
                                ...
                                className="flex items-center gap-2 px-3 py-1.5 bg-gray-800 dark:bg-gray-700 hover:bg-gray-700 dark:hover:bg-gray-600 disabled:opacity-50 text-white text-sm rounded-lg transition-colors"
                            >
                ...
                {activeTab === 'merge' && (
                    <div className="space-y-5">
                        <div className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
                            ...
                            <p className="text-xs text-amber-600 dark:text-amber-400">Note : Silae n&apos;est pas disponible via Merge.dev — utilisez l&apos;onglet Silae pour une connexion directe.</p>
                        </div>

                        <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-4 space-y-3">
                            <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300">Connexion prestataire RH</h4>
