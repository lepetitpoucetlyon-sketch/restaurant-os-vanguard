...
import { SovereignData, SovereignValue, SovereignField } from "@/shared/nexus/contracts";
...
export const StandardSettingsEngine = <K extends keyof GlobalSettings>({ schema }: StandardSettingsEngineProps<K>) => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const sanitizedData = SharedKernel.sync(schemaKey, localData, schema.fields as unknown as import("@/shared/nexus/contracts").SovereignSchemaField[]);
