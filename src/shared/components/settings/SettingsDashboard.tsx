...
const SETTINGS_CATEGORIES = [
    { id: 'onboarding-checklist', label: 'Checklist Mise en Service', icon: ClipboardCheck, description: 'Audit J-0 & Progression des 8 Piliers' },
    { id: 'maintenance', label: 'Maintenance & Alertes', icon: Wrench, description: 'GMAO, Alertes & Zones Restaurant' },
    ...
    { id: 'nexus', label: 'Nexus AI (Mère)', icon: Bot },

    { id: 'identity', label: 'Identité & Restaurant', icon: Building2 },
    { id: 'hours', label: 'Horaires & Disponibilités', icon: Clock },
    { id: 'menu', label: 'Menu & Carte', icon: UtensilsCrossed },
    { id: 'recipes', label: 'Recettes & Fiches', icon: ChefHat },
    { id: 'inventory', label: 'Inventaire & Stocks', icon: Package },
    { id: 'staff', label: 'Équipe & RH', icon: Users },
    { id: 'planning', label: 'Planning & Shifts', icon: CalendarDays },
    { id: 'reservations', label: 'Réservations', icon: BookOpen },
    { id: 'customer', label: 'Customer Clients', icon: Heart },
    { id: 'pos', label: 'Point de Vente', icon: CreditCard },
    { id: 'accounting', label: 'Comptabilité', icon: Receipt },
    { id: 'delivery', label: 'Livraison & Click-Collect', icon: Truck },
    { id: 'reviews', label: 'Avis & Réputation', icon: Star },
    { id: 'appearance', label: 'Apparence & Thème', icon: Palette },
    { id: 'notifications', label: 'Notifications & Alertes', icon: Bell },
    { id: 'security', label: 'Permissions & Droits Équipe', icon: Shield, description: 'Matrice RBAC & sécurité' },
    { id: 'dlq-diagnostics', label: 'Tour de Contrôle & DLQ', icon: RotateCcw, description: 'Résilience réseau & transactions' },
    { id: 'goals', label: 'Objectifs & KPIs', icon: Target },
    { id: 'integrations', label: 'Intégrations & API', icon: Plug },
    { id: 'legal', label: 'Documents & Légal', icon: FileText },
    { id: 'haccp', label: 'HACCP & Hygiène', icon: Shield },
    { id: 'migration', label: 'Migration & Import (IA)', icon: Database },
    { id: 'tables', label: 'Tables & Zones', icon: LayoutGrid },
    { id: 'printer', label: 'Imprimante', icon: Receipt },
    { id: 'tpe', label: 'Terminaux de paiement', icon: CreditCard },
    { id: 'cash-drawer', label: 'Tiroir-caisse', icon: Wallet },
];
