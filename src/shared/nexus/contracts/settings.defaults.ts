...
export const defaultSettings: GlobalSettings = {
    ...
    reservationSettings: {
        ...
        confirmationMessage: "Bonjour {prenom}, votre réservation pour {couverts} pers. chez {restaurant} est confirmée le {date} à {heure}. Pour modifier ou annuler : {lien_modification}",
        reminderMessage: "Bonjour {prenom}, nous vous attendons chez {restaurant} le {date} à {heure} pour {couverts} pers. À très bientôt !",
        cancellationMessage: "Bonjour {prenom}, votre réservation du {date} à {heure} chez {restaurant} a bien été annulée.",
        cancellationPolicy: "Annulation gratuite jusqu'à 2h avant.",
        pacingEnabled: true,
        maxCoversPerPacingSlot: 8,
        pacingSlotMinutes: 15,
        interactiveSmsEnabled: true,
