...
export const defaultSettings: GlobalSettings = {
    ...
    reservationSettings: {
        ...
        confirmationMessage: "Bonjour {prenom}, votre table pour {couverts} pers. chez {restaurant} est confirmée le {date} à {heure}. Pour modifier ou annuler : {lien_modification}",
