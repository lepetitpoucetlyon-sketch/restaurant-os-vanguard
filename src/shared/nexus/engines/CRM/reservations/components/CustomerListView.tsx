...
import { cinematicContainer, cinematicItem } from "@/shared/nexus/engines/CRM/reservations/constants";
import { useInfiniteScroll } from "@/shared/hooks/useVirtualization";

interface CustomerListViewProps {
    customers: import('@/shared/nexus/engines/CRM/customers').CRM[];
    setSelectedCustomer: (customer: import('@/shared/nexus/engines/CRM/customers').CRM) => void;
}
