    ...
    clone: {
      ...
      tiers: {
        STANDARD: {
          ...
          period: '/mois',
          tagline: 'Essentiel',
          features: ['1 caisse POS NF525', 'Gestion tables & tickets', 'Rapports journaliers', 'Support email 5j/7'],
        },
        PREMIUM: {
          price: '99 €',
          period: '/mois',
          tagline: 'Recommandé',
          features: ['3 caisses POS + KDS', 'HACCP & traçabilité', 'Fidélité & marketing', 'Support prioritaire 7j/7'],
        },
        ENTERPRISE: {
          price: 'Sur devis',
          period: '',
          tagline: 'Illimité',
          features: ['Caisses illimitées + multi-sites', 'API & intégrations custom', 'SLA garanti 99,9%', 'Account manager dédié'],
        },
      },
    },
    audit: {
    ...
    clone: {
      ...
      tiers: {
        STANDARD: {
          ...
          period: '/month',
          tagline: 'Essential',
          features: ['1 NF525 POS terminal', 'Tables & ticket management', 'Daily reports', 'Email support 5d/7'],
        },
        PREMIUM: {
          price: '€99',
          period: '/month',
          tagline: 'Recommended',
          features: ['3 POS + KDS terminals', 'HACCP & traceability', 'Loyalty & marketing', 'Priority support 7d/7'],
        },
        ENTERPRISE: {
          price: 'Custom',
          period: '',
          tagline: 'Unlimited',
          features: ['Unlimited POS + multi-site', 'API & custom integrations', '99.9% SLA guaranteed', 'Dedicated account manager'],
        },
      },
    },
    audit: {
