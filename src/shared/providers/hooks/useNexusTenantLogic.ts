...
import {  GeminiProvider  } from '@/bootstrap/legacy';;
...
import { tenantConfigAtom } from '@/bootstrap/store/pillars/sovereign';
import { fetchRbacConfigAtom } from '@/bootstrap/store/pillars/rbac';
