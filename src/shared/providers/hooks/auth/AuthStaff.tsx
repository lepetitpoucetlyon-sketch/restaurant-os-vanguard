...
async function buildUserPatch(data: Partial<User>, userId: string): Promise<import("@/shared/nexus/contracts").SovereignData> {
    const patch: import("@/shared/nexus/contracts").SovereignData = {};
    for (const [key, value] of Object.entries(data)) {
        if (value !== undefined) patch[key] = value as import("@/shared/nexus/contracts").SovereignField;
    }
