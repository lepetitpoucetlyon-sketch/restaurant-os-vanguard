    ...
    return (
        <div className="w-[380px] bg-bg-secondary p-12 flex flex-col justify-between shrink-0 border-l border-border">
                ...
                {selectedCustomer ? (
                    ...
                    >
                        <div className="space-y-4">
                            <p className="text-nano font-black text-text-muted uppercase tracking-widest flex items-center gap-2">
                                <Tag className="w-3 h-3 text-accent" /> Habits & Préférences
                            </p>
                            <div className="flex flex-wrap gap-2">
                                {selectedCustomer.preferences.map((pref: string, i: number) => (
                                    <span key={i} className="px-4 py-2 bg-surface-card dark:bg-surface-card/5 text-nano font-black text-text-primary dark:text-text-primary rounded-xl border border-border dark:border-white/5 uppercase tracking-widest shadow-sm">
                                        {pref}
                                    </span>
                                ))}
                            </div>
                        ...
                        <div className="p-8 rounded-[2.5rem] bg-surface-card dark:bg-surface-card/5 border border-accent/20 relative overflow-hidden group shadow-sm">
                            ...
                            <p className="text-nano font-black text-accent uppercase tracking-[0.2em] mb-4 flex items-center gap-2 italic">
                    ...
                    <div className="py-12 text-center space-y-6">
                        ...
                        <p className="text-micro font-black uppercase tracking-[0.2em] text-text-muted max-w-[200px] mx-auto leading-relaxed italic">
            ...
            <div className="space-y-6">
                <div className="flex items-center justify-between text-micro font-black uppercase tracking-widest">
                ...
                <Button
                    ...
                    className="w-full h-20 bg-accent hover:bg-surface-card text-bg-primary rounded-[2rem] font-black text-micro uppercase tracking-[0.3em] transition-all shadow-2xl shadow-amber-500/30 disabled:opacity-20 transform hover:scale-[1.02] flex items-center justify-center gap-3"
                >
