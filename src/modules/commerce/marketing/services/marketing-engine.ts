        ...
        return [
            {
                ...
                meta: {
                    ...
                    canonicalUrl: 'https://' + (identityDefaults.name?.toLowerCase().replace(/\s+/g, '-') || 'restaurant') + '.com'
                },
                openGraph: {
                    type: 'website',
                    title: identityDefaults.name || 'Restaurant OS',
                    description: identityDefaults.shortDescription || 'Premium Kitchen Intelligence',
                    image: identityDefaults.logo || ''
                },
                score: { 
                    overall: baseScore,
                    breakdown: {
                    ...
                    issues: baseScore < 90 ? ['Certaines métadonnées sont incomplètes'] : [],
                    recommendations: baseScore < 90 ? ['Ajoutez une description plus longue pour améliorer le score'] : []
                },
            ...
            },
            {
                ...
                meta: {
                    ...
                    descriptionAutoGenerated: false,
                    keywords: ['menu', identityDefaults.cuisineType || 'cuisine'],
                    robots: { index: true, follow: true },
                    canonicalUrl: 'https://' + (identityDefaults.name?.toLowerCase().replace(/\s+/g, '-') || 'restaurant') + '.com/menu'
                },
                openGraph: {
                    type: 'website',
                    title: `Menu | ${identityDefaults.name || 'Restaurant OS'}`,
            ...
            },
            {
                ...
                meta: {
                    ...
                    robots: { index: true, follow: true },
                    canonicalUrl: 'https://' + (identityDefaults.name?.toLowerCase().replace(/\s+/g, '-') || 'restaurant') + '.com/reservations'
                },
                openGraph: {
                    type: 'website',
                    title: `Book a Table | ${identityDefaults.name || 'Restaurant OS'}`,
