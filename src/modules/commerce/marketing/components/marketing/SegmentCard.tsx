...
export function SegmentCard({ segment }: SegmentCardProps) {
    return (
        <div className="group bg-white/40 dark:bg-neutral-900/40 backdrop-blur-xl border border-white/20 dark:border-white/5 rounded-[2.5rem] p-8 hover:translate-y-[-4px] transition-all duration-300 shadow-sm hover:shadow-xl">
