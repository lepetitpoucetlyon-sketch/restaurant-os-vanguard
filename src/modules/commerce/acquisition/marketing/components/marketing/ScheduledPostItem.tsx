...
export function ScheduledPostItem({ post, socialAccounts }: ScheduledPostItemProps) {
    return (
        <div className="group flex flex-col md:flex-row items-start gap-6 p-6 rounded-3xl bg-surface-card border border-border hover:border-text-primary/20 hover:bg-surface-glass transition-all duration-300">
            <div className="relative w-24 h-24 md:w-32 md:h-32 rounded-2xl bg-surface-glass overflow-hidden shrink-0 shadow-inner">
                ...
                <div className="absolute top-2 left-2 px-2 py-1 bg-surface-card/80 backdrop-blur-md rounded-lg text-nano font-bold text-text-primary uppercase tracking-wider border border-border">
                ...
                <div className="flex items-start justify-between">
                    <div className="flex items-center gap-2">
                        {post.platforms.map((p) => {
                            ...
                            return (
                                <div key={p} className="p-1.5 rounded-lg bg-surface-card text-text-primary shadow-sm ring-1 ring-black/5">
