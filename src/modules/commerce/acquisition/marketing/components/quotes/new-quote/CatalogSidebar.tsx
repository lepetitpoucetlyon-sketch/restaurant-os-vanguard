...
import type { QuoteProduct } from './quoteHelpers';
...
export function CatalogSidebar({ isOpen, onClose, products, searchQuery, onSearchChange, onSelectProduct }: CatalogSidebarProps) {
    return (
        <AnimatePresence>
            {isOpen && (
                <motion.div
