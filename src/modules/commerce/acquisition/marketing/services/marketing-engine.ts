...
export const MarketingEngine = {
    ...
    calculateSEOScore(): number {
        ...
        if (identityDefaults.businessType) score += weights.businessType;
        ...
        return [
            ...
            },
            {
                ...
                meta: {
                    title: `Menu | ${id.name}`,
                    titleAutoGenerated: false,
                    description: `Explore our ${id.businessType} culinary creations.`,
                    descriptionAutoGenerated: false,
                    keywords: ['menu', id.businessType || 'cuisine'],
                    robots: { index: true, follow: true },
                    canonicalUrl: `${baseUrl}/menu`,
                },
                openGraph: { type: 'website', title: `Menu | ${id.name}`, description: `Explore our ${id.businessType} culinary creations.` },
    ...
    getKeywords() {
        ...
        const cuisine = identityDefaults.businessType || 'Gastronomies';
