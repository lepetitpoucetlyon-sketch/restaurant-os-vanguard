            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 md:mb-8">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-nano font-bold text-text-muted uppercase tracking-widest">Configuration des Unités</p>
                    </div>
                </div>
                <button 
                    ...
                    >
                        <div className="p-6 bg-bg-primary rounded-2xl border border-border">
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                                <div>
                                    <label className="block text-nano font-bold text-text-muted uppercase tracking-widest mb-2">Numéro</label>
                                    <input
                                        type="text"
                                ...
                                <div>
                                    <label className="block text-nano font-bold text-text-muted uppercase tracking-widest mb-2">Couverts</label>
                                    <input
                                        type="number"
                                ...
                                <div>
                                    <label className="block text-nano font-bold text-text-muted uppercase tracking-widest mb-2">Zone</label>
                                    <select
                                ...
                                <div>
                                    <label className="block text-nano font-bold text-text-muted uppercase tracking-widest mb-2">Forme</label>
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="flex items-center justify-between text-xs">
                                ...
                                <span className="px-2 py-0.5 rounded-lg text-nano font-bold text-secondary truncate max-w-[80px]" style={{ backgroundColor: zone?.color }}>
                                    {zone?.name || 'N/A'}
                                </span>
                            </div>
                        </motion.div>
