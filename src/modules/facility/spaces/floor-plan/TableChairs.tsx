        ...
        chairs.push(
            <Group key={i} x={x} y={y} rotation={rotation}>
                ...
                <Arc
                    ...
                    angle={360}
                    rotation={0}
                    fill={isSelected ? (isDarkMode ? "var(--color-brand)" : "#333") : (isDarkMode ? "#1A1A1A" : "#F1F5F9")} // Lighter 3D shade
                    stroke={isSelected ? (isDarkMode ? "#FFFFFF" : "var(--color-brand)") : (isDarkMode ? "#333" : "var(--color-border)")}
                    strokeWidth={1}
                    shadowColor="black"
                ...
                <Arc
                    ...
                    fill={isSelected ? (isDarkMode ? "var(--color-brand)" : "#333") : (isDarkMode ? "#2A2A2A" : "#E2E8F0")}
                    stroke={isSelected ? (isDarkMode ? "#FFFFFF" : "var(--color-brand)") : (isDarkMode ? "#333" : "var(--color-border)")}
                    strokeWidth={1}
                    opacity={1}
                    cornerRadius={5}
