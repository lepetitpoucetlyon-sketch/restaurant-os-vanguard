...
export const ZoneRenderer = ({ tables, zones, isLocked, onUpdateTablePosition, onUpdateZone, isDarkMode }: ZoneRendererProps) => {
                        ...
                        >
                            ...
                            <Group x={x + 30} y={y - 25}>
                                <Rect
                                    ...
                                    stroke={isDarkMode ? "var(--color-brand)" : zone.color}
                                    strokeWidth={3}
                                    shadowColor="black"
                                    shadowBlur={10}
                                    shadowOpacity={0.15}
                                ...
                                <Text
                                    ...
                                    fontFamily="Outfit"
                                    fontStyle="900"
                                    fill={isDarkMode ? "var(--color-brand)" : "#000000"}
                                    align="center"
                                    letterSpacing={4}
                                />
                            </Group>
