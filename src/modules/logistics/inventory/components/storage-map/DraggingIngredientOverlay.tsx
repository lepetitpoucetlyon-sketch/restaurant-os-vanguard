...
export function DraggingIngredientOverlay({ ingredient }: { ingredient: Ingredient }) {
    return (
        <div className="flex items-center gap-3 p-4 bg-surface-card dark:bg-bg-secondary rounded-2xl border-2 border-emerald-500 shadow-2xl shadow-emerald-500/20 min-w-[220px]">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-status-success to-status-success flex items-center justify-center text-white">
