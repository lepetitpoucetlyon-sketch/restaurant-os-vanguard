      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="p-5 rounded-2xl bg-surface-card border border-border-default space-y-3">
          ...
          <div className="text-xs text-text-secondary space-y-1">
            <div>BL Fournisseur : <strong className="text-text-primary">BL-98765</strong></div>
            <div>Motif : <span className="text-red-400 font-semibold">1x Colis Beurre manquant (-88,00 € HT)</span></div>
            <div>Avoir réclamé : <strong className="text-text-primary">92,84 € TTC</strong></div>
          </div>
        ...
        <div className="p-5 rounded-2xl bg-surface-card border border-border-default space-y-3">
          ...
          <div className="text-xs text-text-secondary space-y-1">
            <div>BL Fournisseur : <strong className="text-text-primary">BL-44102</strong></div>
