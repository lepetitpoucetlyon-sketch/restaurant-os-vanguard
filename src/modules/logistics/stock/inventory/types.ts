...
export interface InventoryContextType {
    ...
    expert: {
        queryExpert: (prompt: string, contextData?: import('@nexus/contracts/nexus-contract').SovereignData) => Promise<{
            response: string;
            suggestions?: string[];
        }>;
    ...
    agent?: {
        query: (prompt: string, context?: import('@nexus/contracts/nexus-contract').SovereignData) => Promise<{
            answer: string;
