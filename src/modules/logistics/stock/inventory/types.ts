...
export interface InventoryContextType {
    ...
    expert: {
        queryExpert: (prompt: string, contextData?: import("@/shared/nexus/contracts").SovereignData) => Promise<{
            response: string;
            suggestions?: string[];
        }>;
    ...
    agent?: {
        query: (prompt: string, context?: import("@/shared/nexus/contracts").SovereignData) => Promise<{
            answer: string;
