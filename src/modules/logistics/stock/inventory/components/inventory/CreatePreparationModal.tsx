...
import { ChefHat, X, Check, MapPin, RefreshCw, Calendar } from "lucide-react";
import { IngredientComposition, type UsedIngredient } from './prep/IngredientComposition';
                    ...
                    {success ? (
                        ...
                        <div className="space-y-10">
                            ...
                            <IngredientComposition
                                ...
                                onSelectStockItem={setSelectedStockItem}
                                onChangeQty={setIngredientQty}
                                onAdd={addIngredient}
