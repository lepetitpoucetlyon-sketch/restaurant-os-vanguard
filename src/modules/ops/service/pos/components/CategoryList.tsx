        ...
        <div className="w-16 md:w-[160px] bg-bg-secondary border-r border-border/50 flex flex-col h-full overflow-y-auto scrollbar-hide transition-colors duration-700 relative z-20">
            ...
            <div className="p-2 md:p-4 space-y-2 relative z-10">
                ...
                >
                    ...
                    <span className="hidden md:block text-nano font-black uppercase tracking-[0.3em] group-hover:text-accent-gold transition-colors">{t('pos.back')}</span>
                </button>
                ...
                >
                    ...
                    <span className="hidden md:block text-nano font-black uppercase tracking-[0.3em] relative z-10">{t('pos.favorites')}</span>
                </button>
                ...
                {categories.map((cat) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <span className="hidden md:block text-nano font-black uppercase tracking-[0.2em] text-center relative z-10">{t(`pos.categories.${cat.id}`)}</span>
            ...
            <div className="mt-auto p-4 flex flex-col items-center gap-6 mb-8 relative z-10">
                ...
                <div className="flex flex-col items-center gap-2 group cursor-default">
                    ...
                    <div className="flex flex-col items-center opacity-40">
                        <span className="hidden md:block text-nano font-black text-text-muted uppercase tracking-[0.5em]">OS v2.4</span>
                    </div>
                </div>
            </div>
        </div>
