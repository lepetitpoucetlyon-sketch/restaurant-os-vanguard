    ...
    return (
        <div className="mt-32 pt-16 border-t border-border/30 flex flex-wrap gap-x-16 gap-y-8 items-center justify-center bg-gradient-to-b from-transparent to-bg-tertiary/20 -mx-12 px-12 pb-12">
            <div className="flex flex-col gap-4">
                <span className="text-nano font-black text-accent-gold uppercase tracking-[0.4em] text-center mb-4">{t('pos.flow.table.legendTitle')}</span>
                <div className="flex flex-wrap gap-12 items-center justify-center">
                    <div className="flex items-center gap-4 group">
                        ...
                        <span className="text-nano font-black text-text-muted uppercase tracking-[0.2em]">Disponible</span>
                    </div>
                    <div className="flex items-center gap-4 group">
                        <div className="w-3 h-3 rounded-full bg-accent-gold shadow-glow shadow-accent-gold/40 transition-all group-hover:scale-125" />
                        <span className="text-nano font-black text-text-muted uppercase tracking-[0.2em]">{t('pos.flow.table.installed')}</span>
                    </div>
                    <div className="flex items-center gap-4 group">
                        <div className="w-3 h-3 rounded-full bg-action-primary shadow-glow shadow-blue-500/40 transition-all group-hover:scale-125" />
                        <span className="text-nano font-black text-text-muted uppercase tracking-[0.2em]">{t('pos.flow.table.ordered')}</span>
                    </div>
                    <div className="flex items-center gap-4 group">
                        ...
                        <span className="text-nano font-black text-text-muted uppercase tracking-[0.2em]">En Cours</span>
                    </div>
                    <div className="flex items-center gap-4 group">
                        ...
                        <span className="text-nano font-black text-text-muted uppercase tracking-[0.2em]">Encaissement</span>
                    </div>
                    <div className="flex items-center gap-4 group">
                        ...
                        <span className="text-nano font-black text-text-muted uppercase tracking-[0.2em]">VIP</span>
                    </div>
                </div>
            </div>
        </div>
