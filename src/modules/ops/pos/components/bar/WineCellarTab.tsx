...
import { Wine, WineRegion } from "@domain/types/bar";
                    ...
                    >
                        ...
                        <div className="pl-4">
                            ...
                            <div className="flex items-center justify-between pt-4 border-t border-border">
                                <div>
                                    <p className="text-2xl font-black text-accent dark:text-text-primary">{formatCurrency(wine.priceInCents)}</p>
                                    <p className="text-[10px] text-text-muted">Marge: {(((wine.priceInCents - wine.costPriceInCents) / wine.priceInCents) * 100).toFixed(0)}%</p>
                                </div>
                                <div className={cn(
