...
import type { OraclePrediction } from '../../../services/OracleEngine';
        ...
        <PremiumCard className="overflow-hidden border-accent-gold/20 bg-gradient-to-br from-bg-secondary to-bg-tertiary">
            <div className="p-6 space-y-6">
                ...
                <div className="text-center py-4 relative">
                    <div className="text-nano font-black uppercase tracking-[0.3em] text-accent-gold/60 mb-2">Rupture Estimée</div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                    <div className="bg-bg-primary/50 p-4 rounded-3xl border border-border/5 text-center">
                        <p className="text-nano font-black uppercase opacity-40 mb-1">Pessimiste</p>
                    ...
                    <div className="bg-bg-primary/80 p-4 rounded-3xl border border-accent-gold/20 text-center scale-110 shadow-xl">
                        <p className="text-nano font-black uppercase text-accent-gold mb-1">Médian (P50)</p>
                        <p className="text-xl font-serif italic font-black text-text-primary">{prediction.scenarios.p50}j</p>
                    </div>
                    <div className="bg-bg-primary/50 p-4 rounded-3xl border border-border/5 text-center">
                        <p className="text-nano font-black uppercase opacity-40 mb-1">Optimiste</p>
                ...
                <div className="flex items-center justify-between pt-2 px-2 border-t border-border/10">
                    <div className="flex items-center gap-2">
                        {trendIcon}
                        <span className="text-nano font-black uppercase tracking-wider text-text-muted">Tendance {prediction.trend}</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <Target className="w-4 h-4 text-accent-gold opacity-60" />
                        <span className="text-nano font-black uppercase tracking-wider text-text-muted">Confiance {(prediction.confidence * 100).toFixed(0)}%</span>
                    </div>
                </div>
                ...
                {prediction.riskLevel === 'HIGH' && (
                    ...
                    >
                        ...
                        <p className="text-nano font-medium text-error leading-relaxed">
