...
interface TelemetryEvent {
    ...
    payload?: import('@nexus/contracts/nexus-contract').SovereignData;
    timestamp: string;
    tenantId: string;
}
...
class TelemetryHookService {
     ...
     */
    emit(moduleId: string, eventType: TelemetryEventType, payload?: import('@nexus/contracts/nexus-contract').SovereignData): void {
