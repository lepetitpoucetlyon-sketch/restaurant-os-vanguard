...
import { TenantID } from '@nexus/tokens/brands.types';
...
export const NexusFleetProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    const contextValue: NexusFleetStateInternal = useMemo(() => ({
        ...
        fleet: globalMetrics, 
        customer: { customers: [] as import('@nexus/contracts/nexus-contract').SovereignData[] },
        intelligence: { 
            globalInflationRate,
        ...
        nodes: [] as import('@nexus/contracts/nexus-contract').SovereignData[],
        health: 'stable',
        tutorial: {
            isActive: false,
            step: 0,
