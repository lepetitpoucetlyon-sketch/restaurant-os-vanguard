        ...
        >
            <div className="flex items-start gap-2">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-1.5 mt-1 text-nano text-text-muted">
            ...
            {candidate.notes && (
                <p className="text-micro text-text-muted/70 leading-relaxed line-clamp-2 pl-6">
                    {candidate.notes}
                </p>
            )}

            <div className="flex items-center justify-between pl-6 pt-1 border-t border-border/40">
                <div className="flex items-center gap-1 text-nano text-text-muted/50">
                ...
                {onHire && (
                    <button
                        ...
                        className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-emerald-900/50 hover:bg-emerald-700/60 text-emerald-300 text-nano font-bold uppercase tracking-wider transition-all"
                    >
        ...
        <div className="flex flex-col w-[240px] flex-shrink-0">
            ...
            <div className={cn("flex items-center justify-between mb-3 pb-3 border-b", border)}>
                <div className="flex items-center gap-2">
                    ...
                    <span className={cn(
                        "text-nano font-mono font-bold px-2 py-0.5 rounded-full bg-bg-tertiary",
                        accent
                    )}>
                        {candidates.length}
                    </span>
            ...
            >
                ...
                {candidates.length === 0 && (
                    <div className="flex flex-col items-center justify-center min-h-[80px] text-text-muted/20 gap-2">
                        ...
                        <span className="text-nano uppercase tracking-widest font-bold">Vide</span>
                    </div>
                )}
            </div>
        </div>
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
                ...
                <button
                    onClick={() => openModal()}
                    className="flex items-center gap-2 px-4 py-2 rounded-xl bg-action-primary text-text-primary text-micro font-bold uppercase tracking-widest hover:opacity-90 transition-opacity shadow"
                >
