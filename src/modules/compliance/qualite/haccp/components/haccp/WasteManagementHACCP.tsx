                ...
                <div className="lg:col-span-2 space-y-8">
                    <div className="bg-surface-card dark:bg-bg-secondary rounded-[3rem] border border-border p-10 shadow-sm relative overflow-hidden">
                        ...
                        <div className="relative z-10 space-y-8">
                            ...
                            <Button className="w-full h-16 bg-action-primary text-text-on-primary rounded-[20px] font-black uppercase text-nano tracking-widest hover:bg-action-primary-hover shadow-xl shadow-action-primary/10 transition-all active:scale-[0.98]">
