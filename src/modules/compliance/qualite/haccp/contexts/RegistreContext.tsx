...
import { RegistreContextValue, RegistreState, RegistreAction } from '@nexus/contracts/context/registre.contracts';
...
function registreReducer(state: RegistreState, action: RegistreAction): RegistreState {
    switch (action.type) {
        case 'SET_VASSALS': return { ...state, vassals: action.payload };
        case 'SET_ACTIVE':  return { ...state, activeVassalId: action.payload };
