...
import { BookOpen, Receipt, Landmark, Wallet, ShieldCheck, PlusCircle, Globe } from "lucide-react";
...
export const EInvoicingTab = dynamic(() => import("./_tabs/EInvoicingTab").then(m => m.EInvoicingTab));
...
export { BookOpen, Receipt, Landmark, Wallet, ShieldCheck, PlusCircle, Globe };
