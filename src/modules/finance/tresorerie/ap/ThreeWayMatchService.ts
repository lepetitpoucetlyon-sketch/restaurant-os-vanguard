...
import type { PurchaseOrder, DeliveryNote } from '@/modules/logistics/approvisionnement/procurement';
import type { ExtractedSupplierInvoice } from '@/modules/logistics/domain/schemas/supplier-invoice.schemas';
