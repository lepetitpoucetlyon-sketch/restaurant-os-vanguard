...
export function VatDeclarationTab({ summary }: VatDeclarationTabProps) {
  return (
    <motion.div
      ...
      exit={{ opacity: 0, y: -10 }}
      className="bg-surface-card border border-border-default rounded-2xl p-6 space-y-6"
    >
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-lg font-bold text-text-primary">Ventilation Fiscale TVA & Titres-Restaurant</h3>
          <p className="text-xs text-text-muted">Bases HT et TVA collectée ventilées pour la déclaration mensuelle CA3.</p>
        </div>
        <div className="text-xs text-text-muted bg-surface-glass px-3 py-1.5 rounded-lg border border-border-default">
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left text-xs border-collapse">
          ...
          <tbody className="divide-y divide-border-default/40 font-mono text-text-primary">
            <tr>
          ...
          <tfoot>
            <tr className="border-t border-border-default font-mono font-bold text-text-primary bg-surface-glass">
