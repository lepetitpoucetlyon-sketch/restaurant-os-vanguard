...
export class PowensService {
    ...
    private static CLIENT_ID = process.env.NEXT_PUBLIC_POWENS_CLIENT_ID || 'restaurant-os-master';
    private static CLIENT_SECRET = process.env.POWENS_CLIENT_SECRET || 'industrial-secret';
