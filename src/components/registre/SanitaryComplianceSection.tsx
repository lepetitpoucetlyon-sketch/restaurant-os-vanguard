    ...
    return (
        <div className="max-w-5xl mx-auto space-y-10">
            ...
            <div className="grid grid-cols-1 gap-6">
                {sections.map((s, idx) => (
                    <div key={idx} className="bg-white dark:bg-bg-secondary rounded-3xl border border-border p-8 shadow-sm hover:shadow-xl transition-all duration-500 overflow-hidden relative group">
                        ...
                        <div className="flex flex-col md:flex-row md:items-start justify-between gap-8 relative z-10">
                            <div className="flex-1 space-y-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    {s.mandatory && (
                                        <span className="bg-red-500/10 text-red-500 text-[8px] font-black uppercase tracking-widest px-2 py-0.5 rounded-full border border-red-500/10">Obligatoire</span>
                                    )}
                                </div>
                        ...
                        {s.doc.notes && (
                            <div className="mt-6 pt-6 border-t border-border/50">
                                <p className="text-[10px] font-black text-text-muted uppercase tracking-[0.3em] mb-2 px-1">Notes internes</p>
                                <p className="text-[11px] text-text-muted italic px-1">{s.doc.notes}</p>
                            </div>
                        )}
                    </div>
                ))}
