        ...
        <div className="space-y-8">
            ...
            <div className={cn(
                ...
                <div className={cn(
                    ...
                    stats.overall_status === 'pass' ? "bg-emerald-500 text-white" : "bg-rose-500 text-white"
                )}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-white p-6 rounded-[2rem] border border-slate-100 flex items-center gap-6 shadow-sm">
                    <div className={cn(
                        ...
                        isTruckTempCompliant ? "bg-emerald-50 text-emerald-600" : "bg-rose-50 text-rose-600"
                    )}>
                        <Truck className="w-6 h-6" />
                    </div>
                    <div>
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Véhicule Logistique</p>
                ...
                <div className="bg-white p-6 rounded-[2rem] border border-slate-100 flex items-center gap-6 shadow-sm">
                    <div className={cn(
                        "w-14 h-14 rounded-2xl flex items-center justify-center",
                        stats.temperature_issues === 0 ? "bg-emerald-50 text-emerald-600" : "bg-rose-50 text-rose-600"
                    )}>
                        <Thermometer className="w-6 h-6" />
                    </div>
                    <div>
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Items Thermiques</p>
                        <p className="font-bold text-slate-900">
            ...
            {(stats.items_rejected > 0 || stats.visual_issues > 0) && (
                <div className="p-8 rounded-[3rem] bg-slate-900 text-white space-y-4">
