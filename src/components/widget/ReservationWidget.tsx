...
export default function ReservationWidget({ tenantId, restaurantName }: Props) {
  ...
  // Generate date options (today + 90 days)
      ...
      <div className="px-6 pt-5 pb-6" style={{ minHeight: 340 }}>
        <AnimatePresence mode="wait" custom={direction}>
          ...
          >
            ...
            {step === 2 && (
              <div className="space-y-4">
                ...
                <p className="text-sm text-gray-500">
                  {form.date
                    ? format(parseISO(form.date), "EEEE d MMMM", { locale: fr })
                    : ''}
                </p>
              ...
              <div className="space-y-4">
                ...
                {loadingSlots ? (
                  ...
                  <p className="text-center text-gray-500 py-10 text-sm">
                    Aucune disponibilite pour cette date. Essayez un autre jour.
                  </p>
                ) : (
            ...
            {step === 4 && (
              <div className="space-y-4">
                <h2 className="text-xl font-serif font-semibold text-gray-900">Vos coordonnees</h2>
                <input
            ...
            {step === 5 && (
              <div className="space-y-4">
                <h2 className="text-xl font-serif font-semibold text-gray-900">Email et telephone</h2>
                <input
                  className={inputClass}
                  type="email"
                  placeholder="Email"
            ...
            {step === 6 && (
              <div className="space-y-4">
                <h2 className="text-xl font-serif font-semibold text-gray-900">Remarques particulieres</h2>
                <textarea
                  className={`${inputClass} resize-none`}
                  rows={4}
                  placeholder="Allergie, occasion speciale, besoin d'accessibilite... (optionnel)"
                  value={form.notes}
                ...
                <div className="flex gap-3">
                  ...
                  >
                    {submitting ? (
                      <><Loader2 className="w-4 h-4 animate-spin" /> Reservation en cours...</>
                    ) : (
                      <>Confirmer la reservation <CheckCircle2 className="w-4 h-4" /></>
                    )}
                  </button>
                </div>
              </div>
            ...
            {step === 7 && (
              <div className="flex flex-col items-center text-center py-6 space-y-5">
                ...
                <div className="space-y-2">
                  <h2 className="text-2xl font-serif font-bold text-gray-900">Reservation confirmee !</h2>
                  <p className="text-gray-500 text-sm">
                    Merci {form.firstName}, votre table est reservee chez {restaurantName}.
                  </p>
                </div>
                <div className="rounded-2xl bg-amber-50 border border-amber-200 px-6 py-4 space-y-1 w-full">
                  <p className="text-xs font-bold text-amber-600 uppercase tracking-widest mb-2">Reference</p>
                ...
                <p className="text-xs text-gray-400">
                  Un email de confirmation a ete envoye a {form.email}
                </p>
