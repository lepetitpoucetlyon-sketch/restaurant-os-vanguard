...
const FloorPlanSetupWizard = dynamic(() => import('@/components/migration/FloorPlanSetupWizard'), { ssr: false });
const CSVTemplateDownloads = dynamic(() => import('@/components/migration/CSVTemplateDownloads'), { ssr: false });
