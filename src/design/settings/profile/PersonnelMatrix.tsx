...
export function PersonnelMatrix({ users, currentUserId, selectedUserId, onSelectUser }: PersonnelMatrixProps) {
    return (
        <motion.div
                ...
                {users.map((user, idx) => (
                    <motion.button
                        ...
                        className={cn(
                            ...
                            selectedUserId === user.id || (!selectedUserId && currentUserId === user.id)
