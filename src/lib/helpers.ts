 ...
 */
export function isEmpty(obj: import('@nexus/contracts/nexus-contract').SovereignData): boolean {
 ...
 */
export function omit<T extends import('@nexus/contracts/nexus-contract').SovereignData, K extends keyof T>(
    obj: T,
    keys: K[]
): Omit<T, K> {
 ...
 */
export function pick<T extends import('@nexus/contracts/nexus-contract').SovereignData, K extends keyof T>(
    obj: T,
    keys: K[]
): Pick<T, K> {
