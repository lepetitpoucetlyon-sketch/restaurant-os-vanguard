...
export const ROLE_LABELS: Record<string, string> = {
    // ── Rôles Canoniques Métier & Tenant ──
    admin: "Administrateur (Propriétaire)",
    directeur: "Directeur d'Établissement",
    manager: "Manager d'Exploitation",
    comptable: "Comptable / Expert-Comptable",
    chef_rang: "Chef de Rang",
    chef_cuisinier: "Chef de Cuisine",
    serveur: "Serveur(se) / Runner",
    cuisinier: "Cuisinier / Commis",
    barman: "Barman / Sommelier",
    hotesse: "Hôte(sse) d'Accueil",
    plongeur: "Plongeur / Entretien",
    ...
    operateur: "Opérateur Technique",
    praticien: "Praticien / Médecin",
    expert: "Expert Authentificateur",
    curator: "Gestionnaire Coffre",

    // ── Rôles Plateforme MCC (Fleet) ──
    mcc_super_admin: "Super Admin MCC",
    mcc_support: "Support Plateforme MCC",
    mcc_junior_dev: "Développeur MCC",

    // ── Alias Legacy Compatibilité (English tokens) ──
    super_admin: "Super Admin MCC",
    server: "Serveur (Legacy)",
    kitchen: "Chef de Cuisine (Legacy)",
    "kds-view": "Écran KDS",
    "pos-standard": "Serveur Junior (Legacy)",
    "guest-view": "Convive (Table)",
    floor_manager: "Chef de Rang (Legacy)",
    kitchen_chef: "Chef de Cuisine (Legacy)",
    chef_cuisine: "Chef de Cuisine (Legacy)",
    kitchen_line: "Commis Cuisine (Legacy)",
    bartender: "Barman (Legacy)",
    host: "Hôtesse (Legacy)",
    cashier: "Caisse (Legacy)",
};
...
export const CATEGORY_LABELS: Record<string, string> = {
    ...
    operations: "Opérations & Service",
    hr: "Gestion Humaine & RH",
    marketing: "Fidélité & Marketing",
    finance: "Flux Financiers & Caisse",
    inventory: "Stocks & Recettes",
    quality: "HACCP & Qualité Sanitaire",
