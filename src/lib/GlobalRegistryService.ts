 ...
 */
const orphanNodesRegistry = new Map<string, WeakRef<import('@nexus/contracts/nexus-contract').SovereignData>>();
...
export const GlobalRegistryService = {
     ...
     */
    registerOrphan(id: string, atom: import('@nexus/contracts/nexus-contract').SovereignData) {
