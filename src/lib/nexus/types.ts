...
export interface INexusAdapter {
    get<T = import("@/shared/nexus/contracts").SovereignData>(path: string, context?: NexusContext): Promise<T | null>;
    query<T = import("@/shared/nexus/contracts").SovereignData>(collectionPath: string, options?: INexusQueryOptions, context?: NexusContext): Promise<T[]>;
    onSnapshot<T = import("@/shared/nexus/contracts").SovereignData>(
        path: string,
    ...
    set<T = import("@/shared/nexus/contracts").SovereignData>(path: string, data: T, options?: { merge?: boolean }, context?: NexusContext): Promise<void>;
    update<T = import("@/shared/nexus/contracts").SovereignData>(path: string, data: Partial<T>, context?: NexusContext): Promise<void>;
    increment(path: string, field: string, amount: number, context?: NexusContext): Promise<void>;
    create<T = import("@/shared/nexus/contracts").SovereignData>(path: string, data: T, context?: NexusContext): Promise<void>;
