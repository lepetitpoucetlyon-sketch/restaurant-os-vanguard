...
import { MerchantIdentity } from '@nexus/contracts/settings/identity';
...
export const useSettings = () => {
    ...
    const updateSLM = useCallback(async (data: import('@nexus/contracts/nexus-contract').SovereignData) => {
        if (!settings) return;
    ...
    const updateIdentity = useCallback(async (data: MerchantIdentity) => {
