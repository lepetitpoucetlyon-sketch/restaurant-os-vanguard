...
import('@/verticals/garage').then(m => VerticalRegistry.register('garage', () => new m.GarageVertical()));
import('@/verticals/clinic').then(m => VerticalRegistry.register('clinic', () => new m.ClinicVertical()));
