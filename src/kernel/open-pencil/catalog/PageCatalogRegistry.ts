...
export const RESTAURANT_OS_PAGES_META: readonly RegisteredPageMeta[] = [
    ...
    { id: 'page-menu-engineering', route: '/menu-engineering', name: 'Menu Engineering & Marges', category: 'commerce', description: 'Analyse de rentabilité et popularité des plats', icon: 'TrendingUp', devicePreset: 'desktop', widgets: ['MARGIN_MATRIX', 'FOOD_COST_CHART'] },
    ...
    { id: 'page-intelligence', route: '/intelligence', name: 'Analyses & Recommandations', category: 'management', description: 'Prévisions d affluence, météo et aide à la mise en place', icon: 'Bot', devicePreset: 'desktop', widgets: ['ORACLE_FORECAST', 'AI_PROMPTER'] },
    ...
    { id: 'page-vanguard-simulator', route: '/vanguard-simulator', name: 'Simulateur d Activité & Prix', category: 'management', description: 'Simulation de rush, impact des prix et tests de charge', icon: 'Gauge', devicePreset: 'desktop', widgets: ['LOAD_TEST_PANEL'] },
    ...
    // ── 5. ADMINISTRATION PLATFORME & FLOTTE RÉSEAU (14 pages) ───────────────
    { id: 'page-admin-dashboard', route: '/admin/dashboard', name: 'Admin Cockpit Général', category: 'admin', description: 'Statut du parc de restaurants et métriques globales', icon: 'LayoutDashboard', devicePreset: 'desktop', widgets: ['GLOBAL_FLEET_STATS'] },
    { id: 'page-admin-mcc', route: '/admin/mcc', name: 'Console Réseau & Multi-Sites', category: 'admin', description: 'Console d administration et gestion de la flotte d établissements', icon: 'Gauge', devicePreset: 'desktop', widgets: ['TENANTS_TABLE', 'HEALTH_HEATMAP'] },
    { id: 'page-admin-mcc-dlq', route: '/admin/mcc/dlq', name: 'File d Attente des Erreurs (DLQ)', category: 'admin', description: 'Gestion des événements en échec et outbox résiliente', icon: 'Activity', devicePreset: 'desktop', widgets: ['DLQ_MONITOR'] },
    { id: 'page-admin-agent', route: '/admin/agent', name: 'Superviseur des Tâches & Services', category: 'admin', description: 'Surveillance des processus d arrière-plan et synchronisation', icon: 'Bot', devicePreset: 'desktop', widgets: ['AGENTS_LIVENESS'] },
    { id: 'page-admin-prospecting', route: '/admin/prospecting', name: 'Import de Charte & Personnalisation', category: 'admin', description: 'Extraction automatique de logo et palette graphique', icon: 'Sparkles', devicePreset: 'desktop', widgets: ['DNA_CRAWLER_UI'] },
    { id: 'page-admin-simulation', route: '/admin/simulation', name: 'Générateur de Données Démo', category: 'admin', description: 'Génération de flux de commandes de test pour démos', icon: 'Activity', devicePreset: 'desktop', widgets: ['SIMULATION_CONTROLS'] },
    { id: 'page-admin-blueprint', route: '/blueprint', name: 'Architecture & Schémas Techniques', category: 'admin', description: 'Cartographie des dépendances et structure de la plateforme', icon: 'Network', devicePreset: 'desktop', widgets: ['MIND_MAP_CANVAS'] },
    { id: 'page-admin-design-system', route: '/design-system', name: 'Design System & Primitives UI', category: 'admin', description: 'Vitrine des 22 primitives et tokens de l interface', icon: 'Sparkles', devicePreset: 'desktop', widgets: ['DS_GALLERY'] },
    ...
    { id: 'page-pricing', route: '/pricing', name: 'Grille Tarifaire & Abonnements', category: 'marketing', description: 'Tarifs transparents : Starter, Pro, Entreprise et options', icon: 'Banknote', devicePreset: 'desktop', widgets: ['PRICING_CARDS', 'FAQ_ACCORDION'] },
