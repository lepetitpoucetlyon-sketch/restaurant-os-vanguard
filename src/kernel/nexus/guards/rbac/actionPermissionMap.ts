/**
 * ACTION_MAP — Matrice des permissions par page et action.
 * Source unique de vérité pour useActionPermission et useThresholdCheck.
 * Modifier ici pour ajuster les niveaux d'accès — jamais dans le hook.
 */
...
export const ACTION_MAP: Record<string, Record<string, ActionConfig>> = {
    pos: {
    ...
    timeclock: {
        clock_self:            { minLevel: PERMISSION_ROLE_LEVELS.plongeur,  requiresPin: true },
