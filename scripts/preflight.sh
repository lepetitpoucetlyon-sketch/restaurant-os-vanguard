...
FR_HARDCODED_MAX=688         # chaînes FR en dur hors legal & verticals. 777→751→728→688 (2026-09-03) : lots POS + KDS/cuisine/bar + ops restants (menu/kiosk/recipe-editor/recipe-detail/workflow/product-form, 5 locales) migrés — PLAN-DETTE-UI phase 1.
