...
DS_OUTSIDE_MAX=19            # écrans fabriquant de l'UI hors design system — 485→27→19 après exemption src/app/(marketing)/** (design conversion distinct par décision produit, 2026-08-30)
