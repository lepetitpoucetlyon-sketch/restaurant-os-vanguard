...
FR_HARDCODED_MAX=767         # chaînes FR en dur hors legal & verticals. 777 → 773 → 770 → 767 (2026-09-02)
HARDCODED_HEX_MAX=803        # couleurs #hex ET rgba() en dur. 958→955→803 (2026-09-03) : whitelist générateurs HTML email/print/report + couches de définition palette (ui.foundations, constants, StyleTokens).
